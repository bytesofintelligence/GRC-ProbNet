...
PRED_FILE = "classification_ensemble_mean_std/predictions.csv"
OUT_DIR = BASE_DIR
...
def main():
    ...
    json_path = os.path.join(OUT_DIR, "aggregate_results_ensemble_mean_std.json")
    ...
    csv_path = os.path.join(OUT_DIR, "aggregate_results_ensemble_mean_std.csv")
