...
PRED_FILE = "classification_uncertainty/predictions.csv"
OUT_DIR = BASE_DIR
...
def main():
    ...
    json_path = os.path.join(OUT_DIR, "aggregate_results_uncertainty.json")
    ...
    csv_path = os.path.join(OUT_DIR, "aggregate_results_uncertainty.csv")
