...
PRED_FILE = "classification_ensemble_mean_only/predictions.csv"
OUT_DIR = BASE_DIR
...
def main():
    ...
    json_path = os.path.join(OUT_DIR, "aggregate_results_ensemble_mean_only.json")
    ...
    csv_path = os.path.join(OUT_DIR, "aggregate_results_ensemble_mean_only.csv")
