...
PRED_FILE = "classification_unc_bundle/predictions_unc_bundle.csv"
OUT_DIR = BASE_DIR
...
def main():
    ...
    json_path = os.path.join(OUT_DIR, "aggregate_results_unc_bundle.json")
    ...
    csv_path = os.path.join(OUT_DIR, "aggregate_results_unc_bundle.csv")
