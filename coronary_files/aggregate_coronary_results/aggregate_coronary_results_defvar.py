...
PRED_FILE = "classification_defvar/predictions_defvar.csv"
OUT_DIR = BASE_DIR
...
def main():
    ...
    json_path = os.path.join(OUT_DIR, "aggregate_results_defvar.json")
    ...
    csv_path = os.path.join(OUT_DIR, "aggregate_results_defvar.csv")
