...
dimension. Per-structure uncertainty uses per-class binary entropy with soft-mask thresholding
to avoid dilution from near-zero background voxels. Threshold sweep over multiple
